...
namespace grade_app
{
    ...
    {
        public StudentDiscipline StudentDiscipline { get; private set; } = new();
        public StudentJournal studentJour { get; private set; } = new();
        ...
        private void FillCreditInfo(int SemesterRate)
        {
            ...
            {
                long BonusID = StudentDiscipline.DisciplineMap.Bonus;
